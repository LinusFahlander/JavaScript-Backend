  ...
  return (
    <section className="contact-form mt-5">
      <div className="container">
        ...
        { submitted ? (<AlertNotification alertType="success" title="Thank you for you comment!" text="We will contact you as soon as possible." />) : (<></>) }
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div>
            <input id="email" className={(errors.email ? 'error': '')} value={formData.name} onChange={(e) => handleChange(e)} type="email" placeholder="Your Mail" />
